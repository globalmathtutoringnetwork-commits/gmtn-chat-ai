...
# App UI
st.set_page_config(page_title="GMTN AI Agent", page_icon="📚", layout="centered")
...
# System prompt (can’t inject directly, so we prepend to user input)
SYSTEM_PROMPT = """
...
st.sidebar.markdown("- 🌐 [Website](https://global-math-tutoring-network.netlify.app/)")
st.sidebar.markdown("- 📧 Email: globalmathtutoringnetwork@gmail.com")
st.sidebar.markdown("- 📸 [Instagram](https://www.instagram.com/global_math_tutoring_network/)")
